...
public class GetCatalogStoragesCommand implements Command {
	...
	public String execute(String request) {
		...
		try {
			List<String> newCatalog = assetStorageService.getCatalogStorages();
			response = TextDataFormatter.convertCatalogToString(newCatalog);
